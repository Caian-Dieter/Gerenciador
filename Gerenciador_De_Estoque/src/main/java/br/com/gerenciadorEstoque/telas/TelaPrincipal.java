...
import br.com.gerenciadorEstoque.telas.*;
...
public TelaPrincipal(Connection conexao) {
    ...
    private void btnProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProdutoActionPerformed
       if (telaProduto == null || !telaProduto.isVisible()) {
        telaProduto = new TelaProduto();  // Sem necessidade de conexão, se não precisar
 ...
 if (telaRelatorio == null || !telaRelatorio.isVisible()) {
        telaRelatorio = new TelaRelatorio();  // Sem necessidade de conexão, se não precisar
    ...
    private void btnMovimentacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMovimentacaoActionPerformed
        ...
        telaMovimentacao = new TelaMovimentacao();  // Sem necessidade de conexão, se não precisar
